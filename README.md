...
Voting application contains various frontend and backend micadadroservices. These microservices are deployed and are available over ingress in Roost Cluster.
